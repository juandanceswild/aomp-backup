...
<div id="navigation" class="col-md-9 col-sm-9">
	...
	if ( function_exists( 'has_nav_menu' ) && has_nav_menu( 'primary-menu' ) ) {
        ...
        ?>
		<li class="menu-item-cat menu-item-type-post_type menu-item-object-page"><a href="<?php echo $shop_page_url ?>">Shop</a><ul class="menu-cat-woo hidden-xs">
...
foreach ($all_categories as $cat) {
    ...
    <form role="search" method="get" id="w-searchform" action="<?php bloginfo('url');?>">
...
?>		
<?php wp_nav_menu( array( 'depth' => 6, 'sort_column' => 'menu_order', 'container' => 'ul', 'menu_id' => '', 'theme_location' => 'top-menu', 'menu_class' => 'nav navbar-nav' ) ); ?>
<?php 
	}
...
function woo_load_site_width_css () {
    ...
    if ( 0 < $layout_width ) {  } else { $layout_width = 940; } 
?>
